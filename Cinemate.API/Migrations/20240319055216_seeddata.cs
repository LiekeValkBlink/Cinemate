    ...
    public partial class seeddata : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 2, 2, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 3, 3, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 4, 6, new DateTime(2024, 3, 19, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 5, 7, new DateTime(2024, 3, 19, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 6, 8, new DateTime(2024, 3, 19, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 7, 1, new DateTime(2024, 3, 19, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 8, 4, new DateTime(2024, 3, 19, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 9, 6, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 10, 8, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 11, 9, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 12, 10, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 13, 1, new DateTime(2024, 3, 20, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 14, 3, new DateTime(2024, 3, 20, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 15, 4, new DateTime(2024, 3, 20, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 16, 6, new DateTime(2024, 3, 20, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 17, 8, new DateTime(2024, 3, 20, 22, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 18, 9, new DateTime(2024, 3, 20, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 19, 1, new DateTime(2024, 3, 21, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 20, 4, new DateTime(2024, 3, 21, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 21, 5, new DateTime(2024, 3, 21, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 22, 6, new DateTime(2024, 3, 21, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 23, 9, new DateTime(2024, 3, 21, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 24, 10, new DateTime(2024, 3, 21, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 25, 1, new DateTime(2024, 3, 21, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 26, 4, new DateTime(2024, 3, 21, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 27, 5, new DateTime(2024, 3, 21, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 28, 3, new DateTime(2024, 3, 22, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 29, 4, new DateTime(2024, 3, 22, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 30, 5, new DateTime(2024, 3, 22, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 31, 6, new DateTime(2024, 3, 22, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 32, 8, new DateTime(2024, 3, 22, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 33, 10, new DateTime(2024, 3, 22, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 34, 3, new DateTime(2024, 3, 22, 22, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 35, 4, new DateTime(2024, 3, 22, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 36, 5, new DateTime(2024, 3, 22, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 37, 7, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 38, 9, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 39, 10, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 40, 2, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 41, 3, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 42, 4, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 43, 7, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 44, 9, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 45, 10, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 46, 1, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 47, 2, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 48, 4, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 49, 5, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 50, 6, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 51, 7, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 52, 8, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 53, 10, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 54, 1, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 55, 2, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 56, 4, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 57, 5, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 58, 8, new DateTime(2024, 3, 25, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 59, 9, new DateTime(2024, 3, 25, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 60, 10, new DateTime(2024, 3, 25, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 61, 1, new DateTime(2024, 3, 25, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 62, 2, new DateTime(2024, 3, 25, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 63, 4, new DateTime(2024, 3, 25, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 64, 5, new DateTime(2024, 3, 25, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 65, 8, new DateTime(2024, 3, 25, 22, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 66, 9, new DateTime(2024, 3, 25, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 67, 10, new DateTime(2024, 3, 25, 22, 0, 0, 0, DateTimeKind.Utc), 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 3, false, "Credit Card", 81.5067193127452m, 13, 1 },
                    { 3, 5, true, "Credit Card", 47.3982675125708m, 29, 5 },
                    { 4, 4, true, "Cash", 70.331592720334m, 22, 2 },
                    { 5, 3, false, "Credit Card", 83.8339322864098m, 25, 1 },
                    { 6, 1, false, "Credit Card", 80.8555683186158m, 34, 5 },
                    { 7, 1, true, "Credit Card", 84.035293912322m, 12, 2 },
                    { 8, 4, true, "Credit Card", 70.0170729039745m, 26, 5 },
                    { 9, 3, true, "Credit Card", 35.7733051403328m, 11, 5 },
                    { 10, 5, false, "Credit Card", 61.3185773285065m, 11, 3 },
                    { 11, 5, true, "Cash", 63.8181623504461m, 19, 3 },
                    { 12, 4, true, "Cash", 45.6300910966272m, 33, 1 },
                    { 13, 4, false, "Credit Card", 67.5089331324881m, 3, 3 },
                    { 14, 2, false, "Credit Card", 27.4445797511834m, 18, 5 },
                    { 15, 3, false, "Cash", 68.6786561111447m, 21, 2 },
                    { 16, 2, true, "Cash", 35.5486538764338m, 11, 3 },
                    { 17, 5, false, "Cash", 31.6090265402508m, 15, 1 },
                    { 18, 3, true, "Credit Card", 30.1914284176144m, 13, 5 },
                    { 19, 5, true, "Credit Card", 10.0890166782347m, 21, 5 },
                    { 20, 2, true, "Cash", 58.8940759868129m, 29, 1 },
                    { 21, 4, false, "Cash", 65.5801318666018m, 29, 3 },
                    { 22, 5, false, "Cash", 55.4473563968347m, 25, 1 },
                    { 23, 2, false, "Cash", 79.6393525067281m, 15, 5 },
                    { 24, 1, false, "Credit Card", 41.6529940149572m, 6, 3 },
                    { 25, 3, false, "Cash", 27.3485627128058m, 2, 3 },
                    { 26, 5, true, "Cash", 45.7206433858815m, 28, 3 },
                    { 27, 3, false, "Credit Card", 88.2659365519085m, 18, 3 },
                    { 28, 4, false, "Cash", 90.2940876054778m, 9, 1 },
                    { 29, 1, true, "Credit Card", 54.1877569192639m, 14, 4 },
                    { 30, 1, true, "Cash", 28.7847046925266m, 9, 3 },
                    { 31, 4, false, "Cash", 86.7005665523849m, 13, 3 },
                    { 32, 4, true, "Cash", 87.583704752121m, 3, 3 },
                    { 33, 5, false, "Credit Card", 31.442371830293m, 24, 1 },
                    { 34, 3, true, "Cash", 7.98271713585068m, 32, 2 },
                    { 35, 2, false, "Credit Card", 29.0200628307309m, 7, 5 },
                    { 36, 2, false, "Cash", 44.6189800370248m, 26, 4 },
                    { 37, 4, true, "Credit Card", 14.9703364249849m, 28, 4 },
                    { 38, 5, false, "Credit Card", 90.041695178662m, 31, 1 },
                    { 39, 3, true, "Credit Card", 6.22685775877866m, 11, 5 },
                    { 40, 2, true, "Credit Card", 42.766754142601m, 10, 4 },
                    { 41, 3, true, "Credit Card", 50.3325385669737m, 27, 4 },
                    { 42, 4, true, "Cash", 91.6143754356194m, 23, 3 },
                    { 43, 3, true, "Cash", 91.9692993599544m, 17, 3 },
                    { 44, 5, false, "Cash", 79.1477608506855m, 32, 2 },
                    { 45, 1, true, "Cash", 99.1312442910157m, 24, 3 },
                    { 46, 1, true, "Cash", 46.1841492980366m, 3, 2 },
                    { 47, 3, false, "Credit Card", 20.2373871263704m, 3, 4 },
                    { 48, 3, true, "Credit Card", 60.4457502339468m, 31, 4 },
                    { 49, 4, false, "Cash", 43.9717495626988m, 8, 3 },
                    { 50, 4, true, "Credit Card", 19.1072632082561m, 28, 1 }
                });
