    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 18, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 2, 2, new DateTime(2024, 3, 18, 20, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 3, 3, new DateTime(2024, 3, 18, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 4, 6, new DateTime(2024, 3, 18, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 5, 7, new DateTime(2024, 3, 18, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 6, 8, new DateTime(2024, 3, 18, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 7, 1, new DateTime(2024, 3, 18, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 8, 4, new DateTime(2024, 3, 18, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 9, 6, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 10, 8, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 11, 9, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 12, 10, new DateTime(2024, 3, 19, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 13, 1, new DateTime(2024, 3, 19, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 14, 3, new DateTime(2024, 3, 19, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 15, 4, new DateTime(2024, 3, 19, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 16, 6, new DateTime(2024, 3, 19, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 17, 8, new DateTime(2024, 3, 19, 22, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 18, 9, new DateTime(2024, 3, 19, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 19, 1, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 20, 4, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 21, 5, new DateTime(2024, 3, 20, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 22, 6, new DateTime(2024, 3, 20, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 23, 9, new DateTime(2024, 3, 20, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 24, 10, new DateTime(2024, 3, 20, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 25, 1, new DateTime(2024, 3, 20, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 26, 4, new DateTime(2024, 3, 20, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 27, 5, new DateTime(2024, 3, 20, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 28, 3, new DateTime(2024, 3, 21, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 29, 4, new DateTime(2024, 3, 21, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 30, 5, new DateTime(2024, 3, 21, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 31, 6, new DateTime(2024, 3, 21, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 32, 8, new DateTime(2024, 3, 21, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 33, 10, new DateTime(2024, 3, 21, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 34, 3, new DateTime(2024, 3, 21, 22, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 35, 4, new DateTime(2024, 3, 21, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 36, 5, new DateTime(2024, 3, 21, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 37, 7, new DateTime(2024, 3, 22, 20, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 38, 9, new DateTime(2024, 3, 22, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 39, 10, new DateTime(2024, 3, 22, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 40, 2, new DateTime(2024, 3, 22, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 41, 3, new DateTime(2024, 3, 22, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 42, 4, new DateTime(2024, 3, 22, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 43, 7, new DateTime(2024, 3, 22, 22, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 44, 9, new DateTime(2024, 3, 22, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 45, 10, new DateTime(2024, 3, 22, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 46, 1, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 47, 2, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 48, 4, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 49, 5, new DateTime(2024, 3, 23, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 50, 6, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 51, 7, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 52, 8, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 53, 10, new DateTime(2024, 3, 23, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 54, 1, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 55, 2, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 56, 4, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 57, 5, new DateTime(2024, 3, 23, 22, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 58, 8, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 59, 9, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 60, 10, new DateTime(2024, 3, 24, 20, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 61, 1, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 1 },
                    { 62, 2, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 2 },
                    { 63, 4, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 64, 5, new DateTime(2024, 3, 24, 21, 0, 0, 0, DateTimeKind.Utc), 5 },
                    { 65, 8, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 3 },
                    { 66, 9, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 4 },
                    { 67, 10, new DateTime(2024, 3, 24, 22, 0, 0, 0, DateTimeKind.Utc), 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 4, false, "Cash", 85.3516254862192m, 6, 1 },
                    { 3, 1, true, "Cash", 84.1367964172212m, 28, 5 },
                    { 4, 4, false, "Credit Card", 42.6332978321947m, 33, 2 },
                    { 5, 2, false, "Cash", 21.7039731359266m, 34, 4 },
                    { 6, 2, false, "Credit Card", 39.2477828918865m, 19, 2 },
                    { 7, 2, true, "Cash", 48.285127786071m, 24, 3 },
                    { 8, 1, false, "Cash", 40.3491827223963m, 31, 1 },
                    { 9, 5, true, "Cash", 87.5972352445718m, 13, 1 },
                    { 10, 5, false, "Credit Card", 90.5418563913031m, 6, 3 },
                    { 11, 2, true, "Credit Card", 64.7786655936211m, 28, 5 },
                    { 12, 5, false, "Credit Card", 92.9022523399049m, 33, 3 },
                    { 13, 4, true, "Credit Card", 71.9797827094003m, 35, 2 },
                    { 14, 5, true, "Credit Card", 30.8635779120113m, 29, 4 },
                    { 15, 2, true, "Cash", 58.9720539091296m, 10, 4 },
                    { 16, 5, false, "Credit Card", 53.1742975233041m, 22, 3 },
                    { 17, 1, true, "Credit Card", 90.4297110882736m, 14, 1 },
                    { 18, 3, false, "Cash", 17.166568585927m, 35, 2 },
                    { 19, 4, true, "Credit Card", 17.1040550383112m, 29, 3 },
                    { 20, 4, true, "Cash", 50.298512219972m, 17, 2 },
                    { 21, 1, false, "Cash", 47.4131432607288m, 8, 3 },
                    { 22, 5, true, "Credit Card", 24.3963543567511m, 18, 4 },
                    { 23, 1, true, "Credit Card", 75.9461831838889m, 24, 4 },
                    { 24, 4, false, "Cash", 54.4579236710954m, 24, 4 },
                    { 25, 5, false, "Cash", 99.233205013555m, 35, 2 },
                    { 26, 3, false, "Credit Card", 95.1250267702138m, 1, 1 },
                    { 27, 2, true, "Credit Card", 39.7115067236873m, 9, 4 },
                    { 28, 5, true, "Cash", 31.7506371570688m, 29, 1 },
                    { 29, 2, false, "Credit Card", 94.3805134585953m, 5, 1 },
                    { 30, 4, false, "Cash", 64.5739074868931m, 8, 4 },
                    { 31, 3, true, "Credit Card", 41.6166705539498m, 34, 3 },
                    { 32, 5, false, "Credit Card", 8.25166153986471m, 21, 4 },
                    { 33, 4, false, "Credit Card", 93.7889004235434m, 17, 3 },
                    { 34, 1, true, "Credit Card", 46.3262148339229m, 10, 1 },
                    { 35, 3, false, "Credit Card", 66.486715782788m, 7, 4 },
                    { 36, 2, true, "Cash", 77.9410165192202m, 32, 4 },
                    { 37, 1, false, "Credit Card", 45.341366575696m, 15, 1 },
                    { 38, 5, true, "Credit Card", 91.6174987780191m, 14, 4 },
                    { 39, 3, false, "Cash", 84.9532525054866m, 13, 1 },
                    { 40, 2, false, "Credit Card", 21.1813169722264m, 33, 2 },
                    { 41, 1, false, "Cash", 75.6158270515274m, 3, 5 },
                    { 42, 2, false, "Credit Card", 57.7216516518414m, 16, 5 },
                    { 43, 3, false, "Credit Card", 59.8560919232327m, 21, 4 },
                    { 44, 2, true, "Cash", 39.750938077587m, 20, 2 },
                    { 45, 2, false, "Cash", 19.9576482361418m, 32, 5 },
                    { 46, 1, true, "Cash", 86.916095286946m, 25, 2 },
                    { 47, 4, false, "Credit Card", 80.6291303365325m, 14, 1 },
                    { 48, 5, false, "Cash", 63.1384939552158m, 18, 5 },
                    { 49, 1, true, "Credit Card", 59.1811315663083m, 13, 1 },
                    { 50, 2, false, "Cash", 47.9450865971519m, 24, 1 }
                });
