    ...
    public partial class seeddata : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Timothée Chalamet, Keegan-Michael Key, Michael B. Jordan", "Het verhaal van hoe een jonge Willy Wonka zijn legendarische Oempa-Loempa-medewerkers voor het eerst ontmoet, hoe hij de beroemdste chocoladefabriek ter wereld in handen kreeg en hoe de Oempa-Loempa's hem van de hongerdood redden.", "Paul King", 115, "ZesJaar, GrofTaalgebruik", 1, "US", 2023, 7.1m, false, "Wonka" },
                    { 2, "Sam Worthington, Zoe Saldana, Sigourney Weaver", "The Way of Water: Een vervolg op Avatar (2009).", "James Cameron", 160, "AlleLeeftijden, ZesJaar,TwaalfJaar,ZestienJaar,Geweld,Angst,GrofTaalgebruik,Discriminatie,DrugsEnAlcoholgebruik,Seks", 1, "US", 2022, 7.8m, false, "Avatar: The Way of Water" },
                    { 3, "Kristen Bell, Idina Menzel, Josh Gad", "Anna, Elsa, Kristoff, Olaf en Sven verlaten Arendelle om naar een oud, herfstachtig bos te reizen in een betoverd land. Ze gaan op zoek naar de oorsprong van Elsa's krachten om hun koninkrijk te redden.", "Chris Buck, Jennifer Lee", 103, "ZesJaar, GrofTaalgebruik", 1, "US", 2019, 7m, false, "Frozen II" },
                    { 4, "Jennifer Lawrence, Josh Hutcherson, Liam Hemsworth", "Katniss Everdeen neemt vrijwillig de plaats in van haar jongere zusje in de Hongerspelen: een getelevisieerde competitie waarin twee tieners uit elk van de twaalf districten van Panem willekeurig worden gekozen om tot de dood te vechten.", "Gary Ross", 142, "TwaalfJaar, Geweld, Angst", 1, "US", 2012, 7.2m, false, "The Hunger Games" },
                    { 5, "Daniel Radcliffe, Jodie Foster, Chiwetel Ejiofor", "Een jongen begint aan een queeste om zijn zieke moeder te redden door op zoek te gaan naar een mythische figuur die magische genezende krachten zou hebben.", "Dexter Fletcher", 110, "ZesJaar, GrofTaalgebruik", 1, "US", 2020, 6.8m, false, "Wish" },
                    { 6, "Brittany Bristow, Jordan Dean, Taveeta Szymanowicz", "Twee rivaliserende muzikanten, Lindsay en Wes, belanden per ongeluk in dezelfde stad. Het grootste probleem is dat de band van Lindsay uit elkaar is gevallen en Wes miljonair is geworden, waardoor ze partners worden en het recht krijgen om zich met elkaars leven te bemoeien.", "Josie Day", 96, "AlleLeeftijden", 1, "US", 2022, 6.5m, false, "Anyone But You" },
                    { 7, "Shameik Moore, Hailee Steinfeld, Jake Johnson", "Across the Spider-Verse: Een voortzetting van Spider-Man: Into the Spider-Verse (2018).", "Joaquim Dos Santos, Kemp Powers", 90, "TwaalfJaar, Geweld", 1, "US", 2022, 8m, false, "Spider-Man: Across the Spider-Verse" },
                    { 8, "Cillian Murphy, Robert Downey Jr., Emily Blunt", "Het verhaal van de ontwikkeling van de atoombom door het Manhattan Project tijdens de Tweede Wereldoorlog, en de complexe interpersoonlijke relaties van de briljante maar gebrekkige mannen die het ontwikkelden.", "Christopher Nolan", 120, "TwaalfJaar, Geweld", 1, "US", 2023, 8.5m, false, "Oppenheimer" },
                    { 9, "Margot Robbie", "Barbie en Ken hebben de tijd van hun leven in de kleurrijke en ogenschijnlijk perfecte wereld van Barbie Land. Echter, wanneer ze een kans krijgen om naar de echte wereld te gaan, ontdekken ze al snel de vreugden en gevaren van het leven onder de mensen", "Greta Gerwig", 116, "AlleLeeftijden", 2, "US", 2023, 7.5m, false, "Barbie" },
                    { 10, "Cillian Murphy, Robert Downey Jr., Emily Blunt", "Het verhaal van de ontwikkeling van de atoombom door het Manhattan Project tijdens de Tweede Wereldoorlog, en de complexe interpersoonlijke relaties van de briljante maar gebrekkige mannen die het ontwikkelden.", "Christopher Nolan", 120, "TwaalfJaar, Geweld", 1, "US", 2023, 8.5m, false, "Oppenheimer (3D)" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, true, "Cash", 37.0411424588802m, 10, 2 },
                    { 3, 5, false, "Credit Card", 94.4024961055801m, 11, 2 },
                    { 4, 5, false, "Cash", 68.2130707735802m, 24, 5 },
                    { 5, 5, true, "Credit Card", 91.1809000397874m, 12, 2 },
                    { 6, 1, true, "Cash", 93.1019291151342m, 12, 4 },
                    { 7, 2, true, "Cash", 70.969606962532m, 33, 2 },
                    { 8, 5, false, "Cash", 13.7168710407638m, 12, 1 },
                    { 9, 1, false, "Credit Card", 89.4669651790865m, 13, 5 },
                    { 10, 4, true, "Cash", 68.8446380679468m, 5, 5 },
                    { 11, 2, true, "Credit Card", 10.6329486070622m, 6, 3 },
                    { 12, 5, false, "Credit Card", 50.7519275076432m, 17, 5 },
                    { 13, 2, true, "Cash", 60.2980112322037m, 3, 1 },
                    { 14, 1, false, "Cash", 7.42015900099902m, 34, 2 },
                    { 15, 3, true, "Cash", 41.5302059639926m, 14, 3 },
                    { 16, 3, true, "Credit Card", 93.8613465752596m, 7, 5 },
                    { 17, 3, true, "Credit Card", 23.0481066024088m, 29, 2 },
                    { 18, 4, true, "Credit Card", 4.23731269565946m, 28, 2 },
                    { 19, 3, true, "Cash", 59.3797045016992m, 9, 5 },
                    { 20, 5, true, "Cash", 80.5363180581515m, 33, 2 },
                    { 21, 3, false, "Credit Card", 30.9791787232375m, 12, 2 },
                    { 22, 4, false, "Cash", 86.0495265278405m, 32, 4 },
                    { 23, 5, true, "Cash", 80.7001720356661m, 5, 1 },
                    { 24, 5, false, "Cash", 93.416344058875m, 3, 3 },
                    { 25, 5, false, "Cash", 58.218004355056m, 36, 3 },
                    { 26, 1, false, "Cash", 24.553734319616m, 23, 4 },
                    { 27, 2, true, "Cash", 83.9530480500076m, 22, 5 },
                    { 28, 1, true, "Cash", 64.7171356579707m, 13, 3 },
                    { 29, 2, true, "Credit Card", 86.6138864239454m, 4, 1 },
                    { 30, 3, true, "Cash", 54.9978422693748m, 31, 2 },
                    { 31, 5, true, "Cash", 47.6868704819817m, 4, 3 },
                    { 32, 3, false, "Cash", 47.4337744160727m, 30, 5 },
                    { 33, 4, false, "Credit Card", 32.8267914050069m, 27, 4 },
                    { 34, 2, false, "Cash", 0.288946812776758m, 14, 4 },
                    { 35, 2, true, "Credit Card", 39.0661946499195m, 10, 2 },
                    { 36, 5, false, "Cash", 87.6550929556834m, 15, 1 },
                    { 37, 4, false, "Cash", 43.3212454609256m, 3, 3 },
                    { 38, 1, true, "Cash", 71.4554613778964m, 36, 3 },
                    { 39, 5, false, "Credit Card", 23.7019758616285m, 30, 5 },
                    { 40, 3, true, "Cash", 33.1380095961917m, 24, 4 },
                    { 41, 1, false, "Cash", 2.1307094373175m, 35, 5 },
                    { 42, 4, false, "Credit Card", 19.1251489609033m, 14, 5 },
                    { 43, 5, true, "Credit Card", 17.2267697135751m, 29, 5 },
                    { 44, 4, true, "Cash", 83.8861031505121m, 1, 5 },
                    { 45, 5, false, "Credit Card", 0.676095552970679m, 12, 3 },
                    { 46, 2, true, "Credit Card", 49.9211823141729m, 35, 4 },
                    { 47, 4, false, "Cash", 50.001588928833m, 26, 5 },
                    { 48, 1, false, "Credit Card", 72.3612832415224m, 31, 3 },
                    { 49, 2, false, "Credit Card", 75.1912679910132m, 25, 4 },
                    { 50, 2, false, "Cash", 61.954064048007m, 31, 3 }
                });
