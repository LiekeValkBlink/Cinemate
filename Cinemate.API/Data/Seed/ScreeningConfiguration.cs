...
public class ScreeningConfiguration: IEntityTypeConfiguration<Screening>
{
    public void Configure(EntityTypeBuilder<Screening> builder)
    {
        ...
        builder.HasData(
            ...
            new Screening{ Id = 2, TheaterRoomId = 2, MovieId = 1, MovieStart = today.AddHours(3).SetKindUtc()},
            ...
            new Screening{ Id = 7, TheaterRoomId = 1, MovieId = 1, MovieStart = today.AddHours(6).SetKindUtc()},
            ...
            new Screening{ Id = 13, TheaterRoomId = 1, MovieId = 1, MovieStart = today.AddHours(5).SetKindUtc()},
            ...
            new Screening{ Id = 19, TheaterRoomId = 1, MovieId = 1, MovieStart = today.AddHours(24).SetKindUtc()},
            ...
            new Screening{ Id = 25, TheaterRoomId = 1, MovieId = 1, MovieStart = today.AddHours(24).SetKindUtc()},
